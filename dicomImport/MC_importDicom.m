function [ ct ] = MC_importDicom(filepath, resolution)

%    MC_importDicom: import dicom, no Patient need
FILELIST.resx = resolution(1);
FILELIST.resy = resolution(2);
FILELIST.resz = resolution(3);
[FILELIST.ct, PATIENTLIST] = MC_matRad_scanDicomImportFolder(filepath);
XYZ_resolution = [FILELIST.resx, FILELIST.resy, FILELIST.resz];
ct = MC_matRad_importDicomCt(FILELIST.ct, resolution); 
end
